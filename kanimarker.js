...
var Kanimarker = function () {
  ...
  _createClass(Kanimarker, [{
          ...
          if (mode === "headingup") {
            ...
            if (from - to !== 0) {
              ...
              this.animations.rotationMode = {
                ...
                animate: function animate(frameStateTime) {
    ...
    key: "setPosition",
    value: function setPosition(toPosition, accuracy) {
    ...
    key: "setAccuracy",
    value: function setAccuracy(accuracy) {
    ...
    key: "setHeading",
    value: function setHeading(direction) {
      var silent = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
